...
| `photos.json` | generated index the page is built from: count, and per photo `n` (1 = oldest), `id`, `taken`, `place` (city-level, from the original's GPS — see *Adding a photo*), `desc` (1–3 word image description — see *Adding a photo*), `file`, `thumb`, `video` |
