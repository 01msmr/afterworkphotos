...
import { isFav, toggleFav } from './state.js?v=20260916f';
import { elevator } from './elevator.js?v=20260916f';   // only to ask whether the visitor is in the cabin
import { CARD_D } from './bake.js?v=20260916f';
