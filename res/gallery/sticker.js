...
import { isFav, toggleFav } from 'gallery/state';
import { elevator } from 'gallery/elevator';   // only to ask whether the visitor is in the cabin
import { CARD_D } from 'gallery/bake';
