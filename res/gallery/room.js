...
import { CABIN_LAMP, lightPanel, metal } from './elevator.js?v=20260912x';
import { ENV_INTENSITY, poolMaterial, tex } from './frames.js?v=20260912x';
import { camera, renderer, scene } from './scene.js?v=20260912x';
