...
import { CABIN_LAMP, lightPanel, metal } from './elevator.js?v=20260911a';
import { ENV_INTENSITY, tex } from './frames.js?v=20260911a';
import { camera, renderer, scene } from './scene.js?v=20260911a';
