...
import { CABIN_LAMP, lightPanel, metal } from './elevator.js?v=20260914a';
import { ENV_INTENSITY, PRINT_GLOW, poolMaterial, tex } from './frames.js?v=20260914a';
import { camera, renderer, scene } from './scene.js?v=20260914a';
