...
import { bakeRoom, placeLabels } from './bake.js?v=20260911j';
import { setWire, wire } from './bench.js?v=20260911j';
import { elevator, roomLabel } from './elevator.js?v=20260911j';
import { FRAME, GRID_GAP, sc, textureCache } from './frames.js?v=20260911j';
import { WALL_STYLES, buildRoom, dadoTop, floorOf, rectRoom, shapeOf, wallColours } from './room.js?v=20260911j';
import { scene, world } from './scene.js?v=20260911j';
import { HANG_MAX, pieceY, state } from './state.js?v=20260911j';
import { framedSize, freeTexturesExcept, freeVideosExcept, makePiece } from './video.js?v=20260911j';
import { BODY_R } from './walk.js?v=20260911j';
