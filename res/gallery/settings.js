...
export const OPTIONS = [
	...
	{ key: 'labels', sheet: { kind: 'check' }, apply: v => scene.traverse(o => { if (o.name === 'label' || o.name === 'label-rims') o.visible = v; }) },   // the cards, their shadows, and the stickers on them (their children)
