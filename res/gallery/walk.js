...
import { DOOR, elevator, floors, pressAt } from './elevator.js?v=20260913g';
import { inPoly } from './plan.js?v=20260913g';
import { tabletHit } from './tablet.js?v=20260913g';
import { rectRoom } from './room.js?v=20260913g';
import { ELEVATOR, rooms } from './hang.js?v=20260913g';
import { camera, renderer } from './scene.js?v=20260913g';
import { EYE, state } from './state.js?v=20260913g';
import { stepXR } from './vr.js?v=20260913g';
