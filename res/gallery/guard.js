...
import { elevator, lift } from './elevator.js?v=20260914j';   // its audio, and where the cabin stands
import { ELEVATOR } from './hang.js?v=20260914j';
import { musicLevel, pannerAt } from './music.js?v=20260914j';
