...
import { elevator, lift } from './elevator.js?v=20260914k';   // its audio, and where the cabin stands
import { ELEVATOR } from './hang.js?v=20260914k';
import { musicLevel, pannerAt } from './music.js?v=20260914k';
