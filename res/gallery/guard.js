...
import { elevator, lift } from './elevator.js?v=20260916h';   // its audio, and where the cabin stands
import { ELEVATOR } from './hang.js?v=20260916h';
import { pannerAt } from './music.js?v=20260916h';
